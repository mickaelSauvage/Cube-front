...
const FormInscription = () => {
        ...
        return (
            ...
            <div className="grid grid-cols-4 col-span-8 col-start-2 gap-4">
                <div className="col-span-2 col-start-2 row-start-1 mt-24 text-3xl font-bold text-center text-indigo-900">Inscription</div>
                <span className="col-span-2 col-start-2 row-start-2 text-xl font-bold text-center text-gray-50">Rejoignez la grande aventure citoyenne, relevez le défi !</span>
                <br/><br/><br/><br/><br/><br/>
                <span className="col-start-3 row-start-5 font-bold text-center text-gray-400">Tous les champs sont obligatoires</span>
                <form action="" method="get" className="col-span-2 col-start-2 row-start-5 mt-24 text-center">
