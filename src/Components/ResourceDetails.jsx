...
const ResourceDetails = (props) => {
    ...
    return (
        ...
        <div className="grid grid-cols-4 col-span-8 col-start-2 gap-4 border-0 rounded-lg">
            {
                Res.map(resource => (
                    <div key = {resource.id} className="grid grid-cols-2 col-span-2 col-start-2 p-2 m-4 bg-gray-100 border-4 border-gray-100 rounded-lg" >
                        ...
                        <div key = {51} className="col-start-1 row-start-6 text-gray-500">     
